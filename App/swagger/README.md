...
------------ | ------------- | ------------- | -------------
*ValuesApi* | [**apiStatusByIdGet**](docs/ValuesApi.md#apiStatusByIdGet) | **GET** /api/status/{id} | 
*ValuesApi* | [**apiStatusPost**](docs/ValuesApi.md#apiStatusPost) | **POST** /api/status | 
